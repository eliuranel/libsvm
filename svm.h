...
double svm_predict_values(const struct svm_model *model, int *data_types, const struct svm_node *x, double* dec_values);
double svm_predict(const struct svm_model *model, int *data_types, const struct svm_node *x);
double svm_predict_probability(const struct svm_model *model, int *data_types, const struct svm_node *x, double* prob_estimates);
